...
var index = (function (Module) {
  ...
  return ['DelayableAddon', function (BaseClass) {
    ...
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("RESQUE", flowRuntime_umd.any()), flowRuntime_umd.property("RESQUE_EXECUTOR", flowRuntime_umd.any()), flowRuntime_umd.property("START_RESQUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOBS_QUEUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOB_COMMAND", flowRuntime_umd.any()), flowRuntime_umd.property("DEFAULT_QUEUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOB_RESULT", flowRuntime_umd.any()), flowRuntime_umd.staticMethod("including"))), _dec(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      _inherits(Mixin, _BaseClass);
    ...
    }), _applyDecoratedDescriptor(_class2, "including", [method], Object.getOwnPropertyDescriptor(_class2, "including"), _class2)), _class2)) || _class) || _class);
    QueueTF(Mixin);
    ResqueTF(Mixin);
