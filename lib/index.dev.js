...
var RecoverableStaticInterface = flowRuntime_umd.type("RecoverableStaticInterface", function (RecoverableStaticInterface) {
  var CustomClass = RecoverableStaticInterface.typeParameter("CustomClass");
  return flowRuntime_umd.object(flowRuntime_umd.property("restoreObject", flowRuntime_umd["function"](flowRuntime_umd.param("acModule", flowRuntime_umd.Class(flowRuntime_umd.$propertyType(CustomClass, flowRuntime_umd.string("Module")))), flowRuntime_umd.param("replica", flowRuntime_umd.object(flowRuntime_umd.property("type", flowRuntime_umd.string()), flowRuntime_umd.property("class", flowRuntime_umd.string()))), flowRuntime_umd["return"](flowRuntime_umd.ref("Promise", CustomClass)))), flowRuntime_umd.property("replicateObject", flowRuntime_umd["function"](flowRuntime_umd.param("instance", CustomClass), flowRuntime_umd["return"](flowRuntime_umd.ref("Promise", flowRuntime_umd.object(flowRuntime_umd.property("type", flowRuntime_umd.string()), flowRuntime_umd.property("class", flowRuntime_umd.string())))))));
});
    ...
    _createClass(DelayedJobCommand, [{
      ...
      value: function () {
        var _body = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(aoData) {
          ...
          var T, _aoDataType, _returnType, replicated, moduleName, replica, methodName, args, ApplicationModule, _ProtoType2, vcInstanceClass, _vcInstanceClassType2;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = _context.t0 === 'class' ? 11 : _context.t0 === 'instance' ? 19 : 28;
                  break;

                case 11:
                  _ProtoType2 = flowRuntime_umd.Class(flowRuntime_umd.object(flowRuntime_umd.property("restoreObject", flowRuntime_umd.$propertyType(flowRuntime_umd.ref(RecoverableStaticInterface$1, flowRuntime_umd.ref(Proto)), flowRuntime_umd.string("restoreObject")))));

                  _ProtoType2.assert(Proto);
                ...
                case 19:
                  ...
                  _vcInstanceClassType2 = flowRuntime_umd.Class(flowRuntime_umd.object(flowRuntime_umd.property("restoreObject", flowRuntime_umd.$propertyType(flowRuntime_umd.ref(RecoverableStaticInterface$1, flowRuntime_umd.ref(vcInstanceClass)), flowRuntime_umd.string("restoreObject")))));

                  _vcInstanceClassType2.assert(vcInstanceClass);
        ...
        value: function delay(opts) {
          ...
          return new Proxy(this, {
            get: function get(target, name, receiver) {
              ...
              var _vcClassType = flowRuntime_umd.Class(flowRuntime_umd.object(flowRuntime_umd.property("replicateObject", flowRuntime_umd.$propertyType(flowRuntime_umd.ref(RecoverableStaticInterface$2, flowRuntime_umd.ref("vcClass")), flowRuntime_umd.string("replicateObject")))));

              _vcClassType.assert(vcClass);
        ...
        value: function delay(opts) {
          ...
          return new Proxy(this, {
            get: function get(target, name, receiver) {
              ...
              var _ProtoType = flowRuntime_umd.Class(flowRuntime_umd.object(flowRuntime_umd.property("replicateObject", flowRuntime_umd.$propertyType(flowRuntime_umd.ref(RecoverableStaticInterface$2, flowRuntime_umd.ref(Proto)), flowRuntime_umd.string("replicateObject")))));

              _ProtoType.assert(Proto);
...
var index = (function (Module) {
  ...
  return ['DelayableAddon', flowRuntime_umd.annotate(function (BaseClass) {
    ...
    var _BaseClassType = flowRuntime_umd.Class(flowRuntime_umd.ref(BaseModule));

    flowRuntime_umd.param("BaseClass", _BaseClassType).assert(BaseClass);
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("RESQUE", flowRuntime_umd.any()), flowRuntime_umd.property("RESQUE_EXECUTOR", flowRuntime_umd.any()), flowRuntime_umd.property("START_RESQUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOBS_QUEUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOB_COMMAND", flowRuntime_umd.any()), flowRuntime_umd.property("DEFAULT_QUEUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOB_RESULT", flowRuntime_umd.any()), flowRuntime_umd.staticMethod("including"))), _dec2 = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("RESQUE", flowRuntime_umd.any()), flowRuntime_umd.property("RESQUE_EXECUTOR", flowRuntime_umd.any()), flowRuntime_umd.property("START_RESQUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOBS_QUEUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOB_COMMAND", flowRuntime_umd.any()), flowRuntime_umd.property("DEFAULT_QUEUE", flowRuntime_umd.any()), flowRuntime_umd.property("DELAYED_JOB_RESULT", flowRuntime_umd.any()), flowRuntime_umd.staticMethod("including"))), _dec(_class = _dec2(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      _inherits(Mixin, _BaseClass);
    ...
    }), _applyDecoratedDescriptor(_class2, "including", [method], Object.getOwnPropertyDescriptor(_class2, "including"), _class2)), _class2)) || _class) || _class) || _class);
    QueueTF(Mixin);
    ResqueTF(Mixin);
    ...
    FacadePatchTF(Mixin);
    return Mixin;
  }, flowRuntime_umd["function"](flowRuntime_umd.param("BaseClass", flowRuntime_umd.Class(flowRuntime_umd.ref(BaseModule)))))];
});
